...
let ResumeSummary = class ResumeSummary extends LitElement {
    render() {
        return html `
            <div class="container">
                Ma passion pour les nouvelles technologies ainsi
                que le soucis de livrer du code de qualité tout 
                en appliquant les bonnes pratiques fait de moi 
                un développeur polyvalent et réfléchit
            </div>
    `;
    }
};
